...
public class ErnieBotServiceImpl implements ModelService {
    ...
    private String appSecret = "sZzxHUUaycMaLk2v7t0cnqn3cNiuQkPJ";

    private String apiKey = "41h5ROorVgtQZl21A8JtKYmm";
...
//           https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions?access_token=[步骤一调用接口获取的access_token]
     ...
     * @return token
     */
    public String getAccessToken(String apiKey, String appSecret) {

...
public class ChatGlmServiceImpl implements ModelService {
    ...
    private String apiKey = "6f709c9959adb3459f54d377b18b6202.dZtbr60CkzuUsEKC";
    ...
    public ChatResponseVO chatMessage(ChatRequestDTO dto) throws Exception {
        ...
        HttpResponse response = HttpUtil.createPost(url).body(requestBody)
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer " + generateToken(apiKey, 3600)).execute();
